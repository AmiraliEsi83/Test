...
exports.LondonHarsiStrategy = {
    ...
    evaluate(ctx, config) {
        ...
        const harsi = (0, market_data_1.computeHarsi)(ctx.symbol, ctx.currentPrice, ctx.asianRange || undefined);
        ...
        conditions.push({
            ...
            detail: hasAsianRange
                ? `Midpoint: ${(0, shared_1.formatPrice)(ctx.symbol, harsi.mid)} | Asian Range: ${harsi.rangePips.toFixed(1)} pips`
        ...
        if (isDayAllowed && inWindow && hasAsianRange && cooldownPassed) {
            if (isBuyZone) {
                ...
                const stopLoss = entry - (0, shared_1.fromPips)(ctx.symbol, params.slPips);
                const takeProfit = entry + (0, shared_1.fromPips)(ctx.symbol, params.tpPips);
                signal = {
