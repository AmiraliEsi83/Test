...
class PaperBrokerAdapter {
    ...
    updatePrices(prices) {
        for (const [id, pos] of this.positions.entries()) {
            ...
            if (currentPrice != null) {
                ...
                const { pnlUsd, pnlPips } = (0, shared_1.calcPnl)(pos.symbol, pos.side, pos.entryPrice, currentPrice, pos.lots);
    ...
    async closePosition(id, lotsToClose) {
        ...
        const { pnlUsd } = (0, shared_1.calcPnl)(pos.symbol, pos.side, pos.entryPrice, pos.currentPrice, closingLots);
        ...
        if (closingLots >= pos.lots) {
            ...
            pos.realizedPnl += pnlUsd;
            const rem = (0, shared_1.calcPnl)(pos.symbol, pos.side, pos.entryPrice, pos.currentPrice, pos.lots);
