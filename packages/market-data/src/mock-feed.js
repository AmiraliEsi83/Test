...
class MockMarketFeed {
    ...
    generateHistory(symbol, count = 150) {
        const inst = (0, shared_1.getInstrument)(symbol);
        ...
        const volScale = inst.kind === 'crypto'
            ? 0.002
            : inst.kind === 'metal'
                ? 0.0012
                : inst.kind === 'indices'
...
exports.MockMarketFeed = MockMarketFeed;
