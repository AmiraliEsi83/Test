...
exports.computeHarsi = computeHarsi;
...
function computeHarsi(symbol, price, asianRange) {
    ...
    const value = (0, shared_1.toPips)(symbol, price - mid);
    let zone = 'flat';
    // London HARSI logic:
    ...
    return {
        ...
        rangePips: (0, shared_1.toPips)(symbol, asianRange.high - asianRange.low),
    };
}
