...
export interface RiskSettings {
  userId: string;
  maxRiskPerTradePct: number; // e.g. 1.0 = 1%
  maxPositionSizeLots: number; // e.g. 5.0 lots
  maxDailyLossUsd: number; // e.g. 2500
  maxDailyLossPct: number; // e.g. 3.0 = 3%
  maxOpenPositions: number; // e.g. 5
  maxExposurePerAssetLots: number; // e.g. 2.0
  consecutiveLossThreshold: number; // e.g. 3
  cooldownMinutes: number; // e.g. 120
